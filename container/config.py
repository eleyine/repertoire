...
class Config(object):
    ...
    JSON_LOOKUP_FN = os.path.join(basedir, 'data', 'lookup.json')
    ...
    # Flask-User settings
    USER_APP_NAME = "Répertoire Radiologie CHUM"      # Shown in and email templates and page footers
    ...
    USER_EMAIL_SENDER_EMAIL = "neurorad@rad.ca"
